...
test('AuthenticationCardLogo.vue component imports successfully', async () => {

    expect(AuthenticationCardLogo).toBeTruthy()

})
`;
}
//# sourceMappingURL=generate-authentication-card-logo-test-ts.js.map