...
test('ScrollUpColorModeSection.vue component imports successfully', async () => {

    expect(ScrollUpColorModeSection).toBeTruthy()

})
`;
}
//# sourceMappingURL=generate-scroll-up-color-mode-section-test-ts.js.map